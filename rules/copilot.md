...
**This file should be copied to `.github/copilot-instructions.md` in your project**

*Note: This applies to GitHub Copilot in any IDE, including VSCode, Visual Studio, JetBrains IDEs, etc.*
